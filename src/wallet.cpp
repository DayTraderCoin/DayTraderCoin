...
// DayTraderCoin: total coins staked (non-spendable until maturity)
...
// DayTraderCoin: check 'spent' consistency between wallet and txindex
// DayTraderCoin: fix wallet spent state according to txindex
...
// DayTraderCoin: disable transaction (only for coinstake)
